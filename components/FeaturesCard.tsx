...
const FeaturesCard: FC<FeaturesCardProps> = ({ imageSrc, title, text }) => {
  ...
  return (
    <Link
      href="/404"
      className="group flex min-h-full w-full flex-col items-start justify-start gap-6 rounded-lg border-2 border-primary-purple bg-white p-5 shadow-xxlarge transition-colors hover:bg-primary-purple hover:text-white"
    >
      <Image
        src={imageSrc}
