    ...
    <section>
      <div className="container-large">
        ...
        <div className="grid grid-cols-2 gap-12">
          {/* Feature Event */}
          <div className="relative flex flex-col overflow-hidden rounded-3xl border-2 border-primary-purple shadow-xxlarge">
            {/* Feature Event Top Content */}
            <div className="relative left-0 top-0 z-20 p-5 text-white">
              {/* Event Year */}
